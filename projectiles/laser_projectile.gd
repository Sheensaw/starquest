...
func _on_body_entered(body: Node) -> void:
	...
	if body.is_in_group("enemies"):
		...
		if body.has_method("take_damage"):
			...
			print("LaserProjectilePlayer.gd : Ennemi touché, dégâts infligés : ", damage)
			...
			if player_node and player_node.has_method("add_score"):
				...
				print("LaserProjectilePlayer.gd : Ennemi touché, ", points_per_hit, " points ajoutés au score")
